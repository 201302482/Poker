...
public class EvaluatorTest {
    ...
    @Test
    public void 카드가7장일때_SUIT가_5개가동일하면_플러쉬다() {
        Evaluator evaluator = new Evaluator();
        List<Card> cardList = Arrays.asList(
                new Card(1, Suit.CLUBS),
                new Card(4, Suit.CLUBS),
    ...
    @Test
    public void 카드가7장일때_숫자가_2개가동일하면_원페어다(){
        Evaluator evaluator = new Evaluator();
        List<Card> cardList = Arrays.asList(
                new Card(2,Suit.DIAMONDS),
                new Card(2, Suit.HEARTS),
    ...
    @Test
    public void 카드가7장일때_숫자가_3개가동일하면_트리플이다(){
        Evaluator evaluator = new Evaluator();
        List<Card> cardList = Arrays.asList(
                new Card(2,Suit.DIAMONDS),
                new Card(2, Suit.HEARTS),
    ...
    @Test
    public void 카드가7장일때_숫자가_2개가동일한것이_두쌍있으면_투페어다(){
        Evaluator evaluator = new Evaluator();
        List<Card> cardList = Arrays.asList(
                new Card(2,Suit.DIAMONDS),
                new Card(2, Suit.HEARTS),
    ...
    @Test
    public void 카드가7장일때_숫자가_4개가동일한것이있으면_포카드이다() {
        Evaluator evaluator = new Evaluator();
        List<Card> cardList = Arrays.asList(
    ...
    @Test
    public void 카드가7장일때_숫자가_3개가동일한것과_2개가동일한것이_한쌍씩있으면_풀하우스다 () {
        Evaluator evaluator = new Evaluator();
        List<Card> cardList = Arrays.asList(
                new Card(2, Suit.DIAMONDS),
                new Card(2, Suit.HEARTS),
    ...
    @Test
    public void 카드가7장일때_숫자가_5번연속되면_스트레이트이다 () {
        Evaluator evaluator = new Evaluator();
        List<Card> cardList = Arrays.asList(
                new Card(5, Suit.DIAMONDS),
                new Card(4, Suit.HEARTS),
    ...
    @Test
    public void 카드가7장일때_숫자가_5번연속이고_같은모양이면_스트레이트플러쉬이다() {
        Evaluator evaluator = new Evaluator();
        List<Card> cardList = Arrays.asList(
                new Card(1, Suit.DIAMONDS),
                new Card(2, Suit.DIAMONDS),
    ...
    @Test
    public void 카드가7장일때_숫자가_5번연속이고_모양이_스페이드면_로얄스트레이트플러쉬이다() {
        Evaluator evaluator = new Evaluator();
        List<Card> cardList = Arrays.asList(
                new Card(1, Suit.SPADES),
                new Card(10, Suit.SPADES),
    ...
    @Test
    public void 카드가7장일때_숫자가_5번연속이고_모양이_같고_BACK이면_백스트레이트플러쉬이다() {
        Evaluator evaluator = new Evaluator();
        List<Card> cardList = Arrays.asList(
                new Card(1, Suit.HEARTS),
                new Card(10, Suit.HEARTS),
    ...
    @Test
    public void 카드가7장일때_숫자가_5번연속이고_BACK이면_백스트레이트이다() {
        Evaluator evaluator = new Evaluator();
        List<Card> cardList = Arrays.asList(
                new Card(1, Suit.SPADES),
                new Card(10, Suit.DIAMONDS),
